...
function reg() {
    ...
    while(data_time_line < 180){
        ...
        switch(UI){
            ...
            break;
            case "com.jifen.qukan.login.V2MainLoginActivity":
                    jsclick("id","arr",true,4)
                    (jsclick("text","一键登录",true,4))
            break;
            case "com.jifen.qukan.login.bind.ForceBindWechatActivity":
                    (jsclick("text","马上去绑定",true,4))
            break;
            case "com.jifen.qukan.login.bind.ForceBindTelActivity":
                if(jsclick("text","一键登录",true,2)){
                }else if(jsclick("text","跳过",true,2)){
                }else if (jsclick("text","请输入11位手机号码",false,2)){
        ...
        jsclick("text","先去逛逛",true,2)
        jsclick("text","点击领钱",true,2)
...
var apk_url = "img.wenfree.cn/apk/com.jifen.qukan.apk"
var app_name = "趣头条";
var app_bid = "com.jifen.qukan"
var info={};
