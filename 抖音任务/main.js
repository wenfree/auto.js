                    ...
                    <ScrollView>
                        <vertical marginTop="10">
                            ...
                            <card w="*" h="auto" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" gravity="center_vertical">
                                <vertical padding="18 8" h="auto">
                                    <linear>
                                        <Switch id="editDevice" text="设置任务:" w="auto" textStyle="bold" />
                                    </linear>
                                </vertical>
                            ...
                            <card w="*" h="auto" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" gravity="center_vertical">
                                <vertical padding="18 8" marginBottom="10" h="auto">
                                    ...
                                    <linear>
                                        <text text="任务id:" textColor="black" w="auto" textStyle="bold" />
                                        <input id="task_id" color="#666666" paddingLeft="5" inputType="text" marginLeft="10" w="*" hint="" textSize="14" />
                                    </linear>
                            ...
                            <card w="*" h="auto" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" gravity="center_vertical">
                                <vertical padding="18 8" h="auto">
                                    <linear>
                                        <Switch id="taskMonitor" text="启动任务:" w="auto" textStyle="bold" />
                                    </linear>
                                </vertical>
...
function getData(isSetValue) {
    ...
    let task_id = public.getStorageData(myAPP.imei, "task_id");
    if (phone) {
        myAPP.phone = phone;
    ...
    if (task_id != undefined) {
        myAPP.task_id = task_id
        isSetValue && ui.task_id.setText(myAPP.task_id);
    };

    // let isAllow = myAPP.phone != undefined ? false : true
    let isAllow = myAPP.task_id != undefined ? false : true
...
function saveData() {
    ...
    public.setStorageData(myAPP.imei, "task_id", ui.task_id.text());
};
